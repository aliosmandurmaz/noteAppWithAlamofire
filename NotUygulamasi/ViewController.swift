...
class ViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toNotDetay" {
            ...
            let gidilecekViewController = segue.destination as! NotDetayViewController;
            
            gidilecekViewController.not = notlarListe[indeks!];
    ...
    func tumNotlarAl() {
        ...
        Alamofire.request("http://aodurmaz.xyz/notlar/tum_notlar.php",method: .get).responseJSON {
            response in
